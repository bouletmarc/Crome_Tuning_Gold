...
function addITBToolsToP30() {
  // ITB MAP<->TPS Indexing
  _rom_write(0x0826,
						 new Array(0xC5,0x98,0x08,0xEA,0x12,0x1B,0xF5,0xA3,
											  0xC6,0x88,0x60,0xFC,0x6F,0xCD,0x15,0xC6,
												0x0B,0xCD,0x05,0xC5,0x98,0x18,0xCB,0x06,
												0xC6,0x18,0xC8,0x02,0x77,0x00,0xDC,0x12,
												0x08,0x60,0x1B,0x6B,0xF5,0xB9,0x12),
						 0x27);
  rom.wordAt(0x084D) = 0x0000;
  // ITB MAP<->TPS Table
  _rom_write(0x6FFC, new Array(0xE7,0xFF,0x2C,0x88), 0x04);
  // ITB TPS ReScale
  rom.byteAt(0x088F) = 0x03;
  rom.wordAt(0x0890) = 0x6D34;
  rom.byteAt(0x4473) = 0xB9;
  rom.byteAt(0x4813) = 0xB9;
  _rom_write(0x6D34,
             new Array(0xF5,0x6F,0x60,0xF8,0x6F,0x12,0x44,0x15,
												0x89,0x03,0x92,0x08),
             0x0C);
  // ITB TPS ReScale Table
  _rom_write(0x6FF8, new Array(0xE7,0xE7,0x18,0x18), 0x04);
  // New Column Scalars
  _rom_write(0x7000,
             new Array(0x18,0x39,0x50,0x70,0x88,0x95,0xA9,0xBD,0xD7,0x00),
             0x0A);
  rom.wordAt(0x3C52) = 0x1CCB;
  _rom_fill(0x3C54, 0x3C6F, 0xFF);
}
